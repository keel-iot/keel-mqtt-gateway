...
func runServer() {
	...
	if brokerRuntimeEnabled {
		...
		mqttServer, certReloader, err = broker.New(broker.Config{
			...
			ProxyProtocolTrustedCIDRs: cfg.ProxyProtocolTrustedCIDRs,
			...
			ConnectRateLimitBurst:     cfg.ConnectRateLimitBurst,
			PublishRateLimitPerSec:    cfg.PublishRateLimitPerSec,
			PublishRateLimitBurst:     cfg.PublishRateLimitBurst,
			LiveStats:                 liveStats,
