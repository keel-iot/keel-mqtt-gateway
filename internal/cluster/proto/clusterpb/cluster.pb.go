...
type ForwardRequest struct {
	...
	// protocol field.
	PublishId     string `protobuf:"bytes,6,opt,name=publish_id,json=publishId,proto3" json:"publish_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ForwardRequest) GetPublishId() string {
	if x != nil {
		return x.PublishId
	}
	return ""
...
const file_internal_cluster_proto_cluster_proto_rawDesc = "" +
	...
	"\x03qos\x18\x05 \x01(\rR\x03qos\x12\x1d\n" +
	"\n" +
	"publish_id\x18\x06 \x01(\tR\tpublishId\"\x11\n" +
	"\x0fForwardResponse\"+\n" +
